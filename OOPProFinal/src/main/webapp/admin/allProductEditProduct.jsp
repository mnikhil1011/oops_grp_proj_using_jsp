...
<table class="table-custom">
        ...
        %>
          ...
          <tr>
            ...
            <td><a href="editProduct.jsp?itemcode=<%=rs.getString(2) %>">Edit <i class='fas fa-pen-fancy'></i></a></td>
            <td><a href="deleteProduct.jsp?itemcode=<%=rs.getString(2) %>">Delete <i class='fas fa-pen-fancy'></i></a></td>
          </tr>
         <%
        	}
         }
